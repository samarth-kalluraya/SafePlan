...
class Task(object):
    ...
    def __init__(self):
        ...
        #                     5: ['(l8_1 && l7_2 && l2_3 && l5_4 && l12_5)', 0,    0.7,   1.5,  0],
        #                     6: ['(l13_1 || l13_2 || l13_3 || l13_4 || l13_5)', 0,    0.7,    5,  0],                            
...
#        self.subformula = {1: ['(l1_1 && l2_2 && l4_3 && l5_4  && l6_5)',0,0.8,1.5, 0], # e1 is true if robot in l1
                            # 2: ['(l9_1 && l8_2 && l7_3 && l11_4  && l10_5)',0,0.8,1.5, 0],
                            # # 3: ['(l9_2 && l8_3 && l6_4  && l10_5)',0,0.8,3, 0],
                            # 4: ['(l12_1 && l12_2 && l12_3 && l12_4  && l12_5)',0,0.8,6, 0],
                            # 5: ['(l13_1 || l13_2 || l13_3 || l13_4 || l13_5)',0,0.85,6, 0],
                            # # 6: ['(l4_1 || l4_2 || l4_3 || l4_4 || l4_5)',0,0.85,6, 0],
                            # }
        # self.subformula = {1: ['(l4_1 && l2_2 && l5_3 && l7_4  && l6_5)',0,0.8,5, 0], # e1 is true if robot in l1
        ...
        self.number_of_robots = 2
        # self.formula = '<> e1 && <> e2 && !e1 U e2' 
        # self.subformula = {1: ['(l11_1)',0,0.8,3, 0],
        #                     # 2: ['(l6_1)',0,0.8,1, 0], 
        #                     2: ['(l13_1)',0,0.85,1.5, 0], 
        #                     # 2: ['((l6_1 || l3_1)&& (l2_2 || l1_2))',0,0.8,1, 0], 
        #                     3: ['(l11_1)',0,0.8,6, 0]
        #                     }
        # self.number_of_robots = 5
